...
const AudioNarrator = ({
  ...
  return (
    <div
      className={`fixed ${
        stage === "VOTING" ? "top-7" : "bottom-44 md:bottom-40"
      } left-0 right-0 z-50`}
    >
      <div className="max-w-sm md:max-w-3xl h-20 md:h-16 mx-auto bg-off-white rounded-lg shadow-lg p-4 transform transition-all duration-600 hover:scale-105">
        <div className="flex items-center justify-center space-x-2">
          ...
          <p className="text-md md:text-xl font-sans text-primary-blue font-semibold">
            {currentMessage}
          </p>
        </div>
